    ...
    public static String[] displaySubMenu(Scanner inputScanner, int operationToPerform) {
        ...
        switch (operationToPerform){
            ...
            case 2:
                ...
                break;
            case 3:
                System.out.println("Enter the file name to be renamed in the server");
                inputsFromTheUser[0] = inputScanner.next();
        ...
        if(input!=null){
            try{
                if(fileServer.DeleteFile(input)){
                    System.out.println("Successfully deleted file "+ input);
                }else {
        ...
        if(inputs != null){
            try {
                if(fileServer.RenameFile(inputs[0],inputs[1])){
                    System.out.println("renamed file successfully"+inputs[1]);
                }else{
